...
class DetectionMetrics:
    ...
    def add_label_ap(self, detection_name: str, dist_th: float, semantic_th: float, ap: float) -> None:
        self._label_aps[detection_name]["{}/{}".format(dist_th, semantic_th)] = ap

    def get_label_ap(self, detection_name: str, dist_th: float, semantic_th: float) -> float:
        return self._label_aps[detection_name]["{}/{}".format(dist_th, semantic_th)]
